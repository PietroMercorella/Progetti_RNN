        ...
        for k in range(len(n_layers)):
            for l in range(len(bert_size)):
                ...
                run = wandb.init(
                    ...
                    project="amass_babel_frame_ann_MiniLM_plot",

                    name=f"secondo_{hidden_size_encoder[i]}_{lr[j]}_{n_layers[k]}_{bert_size[l]}",
                ...
                for epoch in tqdm.tqdm(range(EPOCHS)):
                    ...
                    if valid_loss < best_valid_loss:
                        ...
                        torch.save(model.state_dict(), "/home/michieletto/Progetti_per_tesi/Progetto_RNN/Parametri_modello/amass_babel_frame_ann_best_MiniLM.pt")
...
model.load_state_dict(torch.load("/home/michieletto/Progetti_per_tesi/Progetto_RNN/Parametri_modello/amass_babel_frame_ann_best_MiniLM.pt"))
