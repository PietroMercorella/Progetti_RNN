...
print(f"Senza descrizioni: {hidden_size_encoder[0]}_{lr[0]}_{n_layers[0]}")
...
#             model.load_state_dict(torch.load("/home/michieletto/Progetti_per_tesi/Progetti_RNN_git/Parametri_modello/amass_without_frame_annotations.pt"))
...
for zero_velocity in zero_vel:
    ...
    test_loss, predictions, targets = test_fn(model, valid_data_loader, zero_velocity, device)
    ...
    if not zero_velocity:
        EvaluationProtocol.save_all_metrics(
            ...
            metrics_dict=metrics_dict,
            framerate=25,
            csv_path="/home/michieletto/Progetti_per_tesi/Progetti_RNN_git/Risultati_test_csv/amass_without_frame_annotations",
            print_table=False,
        )
    else:
        EvaluationProtocol.save_all_metrics(
            ...
            metrics_dict=metrics_dict,
            framerate=25,
            csv_path="/home/michieletto/Progetti_per_tesi/Progetti_RNN_git/Risultati_test_csv/amass_without_frame_annotations_zero_velocity",
            print_table=False,
        )
